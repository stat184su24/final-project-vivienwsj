...
Our analysis sought to answer the research question: "Is there a correlation between the popularity of manga and the ranking of their anime adaptations?" Using comprehensive datasets from Kaggle, we examined the top-ranked anime and best-selling manga series, focusing on key variables such as anime scores, member counts, and manga sales. The scatter plot visualizing the relationship between anime scores, manga sales, and member counts suggested a positive correlation, with higher manga sales generally corresponding to higher anime scores, and popular anime (with more members) often having higher sales figures. Additionally, the bar plot focusing on the top 20 manga by sales and their corresponding anime rankings provided a more nuanced view, indicating that while several top-selling manga had high-ranking anime adaptations, this trend was not uniform. Some high-selling manga had anime adaptations that did not perform as well in rankings. From our initial intuition and the visualizations, we observe a trend where popular manga tend to have successful anime adaptations. However, the correlation is not absolute; high manga sales do not always guarantee a top-ranked anime adaptation. Factors such as production quality, fidelity to the source material, and audience reception significantly influence the success of an anime adaptation. In conclusion, while there is some correlation between manga popularity and anime rankings, it is not a definitive predictor. The success of an anime adaptation is multifaceted, and manga popularity is just one of many contributing factors. Our findings highlight the complexity of the relationship between manga sales and anime success, suggesting that future research could delve deeper into other influential factors to provide a more comprehensive understanding.